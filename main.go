...
func sendToSlack(message string) {
	webhookURL := "https://hooks.slack.com/services/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"
...
func startJobDatabricks() {
	...
	apiURL := "https://dbc-06fd15fe-d722.cloud.databricks.com/api/2.0/jobs/run-now"
	apiToken := "dapid80ad766d6248b9e8d3be1bcf8ab4aec"
